...
export default defineSchema({
    ...
    groupsList: defineTable({
        ...
        members: v.array(
            v.object({
                ...
                joinedAt: v.number()// "admin", "member"
            })
        ), // array of user ids
    }),
    ...
    settlements: defineTable({
        ...
        relatedExpenseIds: v.optional(v.array(v.id("expenses"))), // array of expense ids related to this settlement
        createdBy: v.id("users"), // reference to users table
    })
        .index("by_group", ["groupId"])
        .index("by_user_and_group", ["paidByUserId", "groupId"])
